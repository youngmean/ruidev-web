...
<head>
    ...
    <style type="text/css">
		...
		*{margin: 0;padding: 0}
		...
		ul li input[type*="button"], ul li input[type*="submit"]{
		    width: 100%;
		    height: 40px;
		...
		ul li input[type*="button"]:hover, ul li input[type*="submit"]:hover{
		    opacity: 0.8;
		}
		ul li input[type*="button"]:active, ul li input[type*="submit"]:active{
		    width: 100%;
		    height: 40px;
		    font-family: Arial, Helvetica, sans-serif;
		    font-size: 18px;
...
<body>
<div class="wrapper">
    <div class="header">Login to <span>TJSW</span></div>
    <form action="${base}/user/login" method="post" autocomplete="off">
        <ul>
            <li>
                <div class="text">
                    <span class="yonghu"></span><input type="text" name="username" placeholder="请输入用户名" autocomplete="off">
                </div>
            </li>
            <li>
                <div class="password">
                    <span class="mima"></span><input type="password" name="password" placeholder="请输入密码" autocomplete="off">
                    <div style="display:none;">
	                    <input type="password" name="__password" placeholder="请输入密码" autocomplete="off">
                    </div>
                </div>
            </li>
            <#--
    ...
    <div class="footer">
        <p><a href="">Copyright ©${.now?string('yyyy')} TJSW</a></p>
        <p></p>
    </div>
</div>
</body>
