...
(function () {
    ...
    function getPrefixUrl(prefix){
    	var _p=prefix;
    	var ll=_p.indexOf('{');
    	var rr=_p.indexOf("}");
    	if(ll>=0&&rr>=0){
    		var vname=_p.substring(ll+1,rr);
    		_p=window[vname]||window.top[vname]||_p;
    	}
    	return _p;
    }
    ...
    OnlineImage.prototype = {
        ...
        pushData: function (list) {
            ...
            urlPrefix = getPrefixUrl(urlPrefix);
