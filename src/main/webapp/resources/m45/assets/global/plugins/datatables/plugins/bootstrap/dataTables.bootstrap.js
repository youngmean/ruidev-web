...
$.extend(true, $.fn.dataTable.defaults, {
	...
	"dom": "<'row'<'col-md-6 col-sm-6'i><'col-md-6 col-sm-6'f>r><'table-scrollable't><'row'<'col-md-5 col-sm-5'l><'col-md-7 col-sm-7'p>>",
...
$.fn.dataTableExt.oApi.fnPagingInfo = function (oSettings) {
    return {
        "iStart": 0,
        "iEnd": oSettings.oInit.pageLength,
        "iLength": oSettings.oInit.pageLength,
        "iTotal": oSettings.oInit.recordsTotal,//.fnRecordsTotal(),
        "iFilteredTotal": oSettings.fnRecordsDisplay(),
        "iPage": oSettings.oInit.iPage/*oSettings._iDisplayLength === -1 ?
            0 : Math.ceil(oSettings._iDisplayStart / oSettings._iDisplayLength)*/,
        "iTotalPages": oSettings.oInit.iTotalPages/*oSettings._iDisplayLength === -1 ?
            0 : Math.ceil(oSettings.fnRecordsDisplay() / oSettings._iDisplayLength)*/,
        "_fnPageChange": oSettings.oInit.onPageChange
    };
};
    ...
    "bootstrap_full_number": {
        "fnInit": function (oSettings, nPaging, fnDraw) {
            ...
            var fnClickHandler = function (e) {
                e.preventDefault();
                oSettings.oInit.onPageChange&&oSettings.oInit.onPageChange(e.data.action);
                return;
                ...
                for (j = iStart; j <= iEnd; j++) {
                    ...
                    $('<li ' + sClass + '><a href="#">' + j + '</a></li>')
                        ...
                        .bind('click', function (e) {
                            e.preventDefault();
                            oSettings.oInit.onPageChange&&oSettings.oInit.onPageChange(parseInt($('a', this).text(), 10) - 1);
                        });
                }
